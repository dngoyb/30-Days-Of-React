...
class Header extends React.Component {
    ...
    render() {
        ...
        return (
            <header style={this.props.styles} style={colors.headerStyles}>
...
class Footer extends React.Component {
    ...
    render() {
        return (
            <footer style={colors.footerStyles}>
...
class App extends React.Component {
    ...
    changeBackground = () => {
        ...
        if (style.backgroundColor === '') {
            ...
            this.setState({ styles: { backgroundColor: '' } });
            colors = {
                headerStyles: { backgroundColor: '#61dbfb' },
                footerStyles: { backgroundColor: '#6cf' },
                hrStyle: { opacity: 0 },
            };
        }
    };
    ...
    render() {
        ...
        return (
            <div className='app' style={this.state.styles}>
                ...
                <Country selectCountry={this.selectCountry} />
                <hr style={colors.hrStyle} />
